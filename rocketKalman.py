...
# ---------------------------------------- Plot the acceleration error in x and y ----------------------------------------
...
plt.figure()
plt.plot(t, a_true_x, label='True Acceleration')
plt.plot(t, (accel_meas_x), label='Noisy Measured Acceleration')
plt.plot(t, (a_est_x), label='Model Estimated Acceleration')
plt.xlabel('Time (s)')
...
plt.figure()
plt.plot(t, a_true_y, label='True Acceleration')
plt.plot(t, (accel_meas_y), label='Noisy Measured Acceleration')
plt.plot(t, (a_est_y), label='Model Estimated Acceleration')
plt.xlabel('Time (s)')
plt.ylabel('Acceleration (m/s^2)')
...
# ---------------------------------------- Plot the velocity error in x and y ----------------------------------------
# Here is where velocity plots are made for true data, noisy sensor readings, and model estimation. This is a good way to see error after integration
# and before filtering

# Plot velocity in the x direction (True data, noisy sensor readings, and model estimation)
plt.figure()
plt.plot(t, v_true_x, label='True Velocity')
plt.plot(t, (velo_meas_x), label='Noisy Measured Velocity')
plt.plot(t, (v_est_x), label='Model Estimated Velocity')
plt.xlabel('Time (s)')
plt.ylabel('Velocity (m/s)')
plt.title('Rocket Velocity Curve (x direction)')
plt.grid(True)
plt.legend()
plt.show()

# Plot velocity in the y direction (True data, noisy sensor readings, and model estimation)
plt.figure()
plt.plot(t, v_true_y, label='True Velocity')
plt.plot(t, (velo_meas_y), label='Noisy Measured Velocity')
plt.plot(t, (v_est_y), label='Model Estimated Velocity')
plt.xlabel('Time (s)')
plt.ylabel('Velocity (m/s)')
plt.title('Rocket Velocity Curve (y direction)')
plt.grid(True)
plt.legend()
plt.show()


# ---------------------------------------- Plot the position error in x and y ----------------------------------------
# Here is where position plots are made for true data, noisy sensor readings, and model estimation. This is a good way to see error after integration and 
# before filtering

# Plot position in the x direction (True data, noisy sensor readings, and model estimation)
plt.figure()
plt.plot(t, p_true_x, label='True Position')
plt.plot(t, (pos_meas_x), label='Noisy Measured Position')
plt.plot(t, (p_est_x), label='Model Estimated Position')
plt.xlabel('Time (s)')
plt.ylabel('Position (m)')
plt.title('Rocket Position Curve (x direction)')
plt.grid(True)
plt.legend()
plt.show()

# Plot position in the y direction (True data, noisy sensor readings, and model estimation)
plt.figure()
plt.plot(t, p_true_y, label='True Position')
plt.plot(t, (pos_meas_y), label='Noisy Measured Position')
plt.plot(t, (p_est_y), label='Model Estimated Position')
plt.xlabel('Time (s)')
plt.ylabel('Position (m)')
plt.title('Rocket Position Curve (y direction)')
plt.grid(True)
plt.legend()
plt.show()
...
q = 5.0 # This is a scaler high q shows trust in sensor measurements while low q shows trust in the model
